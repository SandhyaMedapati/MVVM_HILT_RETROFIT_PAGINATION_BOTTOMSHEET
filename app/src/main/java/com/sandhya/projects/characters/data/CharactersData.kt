...
data class CharactersData(
    ...
    companion object CREATOR : Parcelable.Creator<CharactersData> {
        override fun createFromParcel(parcel: Parcel): CharactersData {
            return CharactersData(parcel)
        }

        override fun newArray(size: Int): Array<CharactersData?> {
